// MakeTrackOccupancyPaper -- a version of MakeNiceTrackOccupancy to make
// the track occupancy plot for the PLT paper. Uses histo_track_occupancy_4892.root
// as input.
...
void MakeTrackOccupancyPaper(void) {
  ...
  c1->Print("TrackOccupancies4892.pdf");
}
