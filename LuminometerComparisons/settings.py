...
cms_label_pos_sq = (0.008, 0.94) # (0.008, 1.02)
cms_label_pos_nsq = (0.008, 0.94) # (0.008, 1.02)
experiment_font_size = 20 # 12
delta_y_pos_sq = 0.08
delta_y_pos_nsq = 0.045

year_energy_label_pos_sq = (0.65, 1.01) # (0.82, 1.01)
year_energy_label_pos_nsq = (0.70, 1.02) # (0.87, 1.02)
year_energy_font_size = 20 # 12
...
limits_linearity_slopes_year = {
    ...
    (2017, 13): (-0.01, 0.01),
    (2017, 5): (-0.01, 0.01),
    (2018, 13): (-0.02, 0.02) # (-0.01, 0.01) # (2018, 13): (-0.05, 0.05)
}
