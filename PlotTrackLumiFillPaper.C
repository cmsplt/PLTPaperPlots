...
//
// This is a modified version with some formatting updates for the
// paper. -- PL, Feb. 21, 2021
//
////////////////////////////////////////////////////////////////////
...
const bool attemptChannelFix = false;
std::string fillNumber = "5109";
...
void PlotTrackLumiFillPaper(void) {
  ...
  std::string brilcalc_name_hfoc = "TrackLumiData/hfoc_"+fillNumber+".csv";
  ...
  std::string pltz_brilcalc_name = "TrackLumiData/pltzero_"+fillNumber+".csv";
  ...
  std::string tracklumi_name = "TrackLumiData/TrackLumiZC_"+fillNumber+".txt";
  ...
  TLegend *l3 = new TLegend(0.3, 0.14, 0.7, 0.34);
  ...
  outFile = "TrackLumiVsTime_"+fillNumber+".pdf";
  c1->Print(outFile.c_str());
  // skip printing this one out, since we don't use it in the paper
  //outFile = "TrackLumiRatiosVsTime_"+fillNumber+".png";
  //c2->Print(outFile.c_str());
  outFile = "TrackLumiRatiosVsSBIL_"+fillNumber+".png";
  c3->Print(outFile.c_str());
  outFile = "TrackLumiRatiosVsSBIL_"+fillNumber+".pdf";
  c3->Print(outFile.c_str());
}
